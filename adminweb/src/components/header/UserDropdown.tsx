...
import { clearAuthSession, getAuthSession } from "@/features/auth/utils/authSession";

export default function UserDropdown() {
  const [isOpen, setIsOpen] = useState(false);
  const navigate = useNavigate();
  const authSession = getAuthSession();
  const displayName = authSession?.tenDangNhap ?? "Admin";
  const roleName = authSession?.vaiTro ?? "ADMIN";
